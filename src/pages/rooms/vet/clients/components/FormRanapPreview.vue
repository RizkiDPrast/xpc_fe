    ...
    content() {
      ...
      let body = `
          ...
          <p style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';font-size:16px;line-height:1.5em;margin-top:0;text-align:left">
            ...
            <ol>
                <li>
                    Bahwa saya memberi kuasa sepenuhnya kepada dokter hewan XING pet care and clinic untuk melaksanakan prosedur yang telah dijelaskan kepada saya dan pengobatan yang disarankan atau dianggap perlu untuk hewan saya. Dengan data-data sebagai berikut :
                    <p> <table style=""width:100%"">
                        <tr><td>Nama hewan </td><td>:</td><td> ${
                          model.patientName
                        } </td></tr>
                        <tr><td>Jenis / Ras </td><td>:</td><td> ${
                          model.animalType
                        } </td></tr>
                        <tr><td>Jenis kelamin </td><td>:</td><td> ${this.getSexType(
                          model.patient.sex
                        )} </td></tr>
                        <tr><td>Umur </td><td>:</td><td> ${
                          model.patient.age
                        } </td></tr>
                        <tr><td>No Rekam Medis </td><td>:</td><td> ${
                          model.clientCode
                        } </td></tr>
                        <tr><td>Kondisi </td><td>:</td><td> ${nullable(
                          model.kondisiHewan
                        )} </td></tr>
                        <tr><td>Saran </td><td>:</td><td> ${nullable(
                          model.saran
                        )?.replaceAll("\n", "<br/>")} </td></tr>
                        <tr><td>Dokter poliklinik </td><td>:</td><td> ${
                          model.vetName
                        } </td></tr>
                    </table> </p> 
                 </li>
                 <li>
                    Bahwa prosedur yang sebenarnya telah diterangkan kepada saya dan tidak ada jaminan yang diberikan untuk hasil atau kesembuhan, karena saya mengerti prosedur tersebut mengandung resiko.
                 </li>
                 <li>
                    Bahwa saya bersedia melunasi pembayaran biaya rawat inap dan pengobatan, termasuk biaya-biaya yang dianggap perlu untuk pengobatan atau keadaan yang tidak dapat di perkirakan sebelumnya, karena perkiraan biaya terlampir hanyalah sekedar perkiraan dan pembayaran sebenarnya pada akhir perawatan mungkin dapat lebih besar atau kurang dari jumlah perkiraan sebelumnya, oleh karena itu saya bersedia melunasi pembayaran sebelum hewan pulang.
                 </li>
                 <li>
                    Bahwa apabila saya ingin melanjutkan pengobatan sampai hewan saya benar-benar sembuh tetapi membutuhkan biaya tambahan dan waktu yang lama, maka saya bersedia menanggung semua resikonya. Saya bersedia tidak ada menuntut dokter hewan dan XING pet care & clinic atas segala kemungkinan yang tejadi.
                 </li>
                 <li>
                    Saya tidak akan menuntu XING pet care & clinic ataupun mengambil kembali hewan saya apabila dalam waktu 7 (tujuh) hari sejak pihak xing pet care & clinic berhak untuk kepemilikan baru terhadap hewan saya tersebut dan saya bersedia dimasukkan ke daftar hitam XING pet care & clinic atas kelalaian yang saya buat.
                 </li>
                 <li>
                    Demikian surat pernyataan ini saya buat dengan sebenarnya, dalam keadaan sehat jasmani dan rohani serta tidak ada tekanan atau paksaan dari pihak manapun juga
                 </li>
            </ol>
          </p>
        `;
