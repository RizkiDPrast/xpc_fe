    ...
    content() {
      ...
      let body = `
          ...
          <p style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';font-size:16px;line-height:1.5em;margin-top:0;text-align:left">
                ...
                mengenai kondisi penyakit <b>${model.animalType}</b> saya, 
                termasuk saran dokter untuk tetap lanjut dirawat inap dengan berbagai pertimbangan. 
                Namun saya memilih untuk melanjutkan treatment <b> ${nullable(
                  model.lanjutDengan
                )} </b>. 
                Dengan alasan: <b> ${nullable(model.alasan)?.replaceAll(
                  "\n",
                  "<br/>"
                )} </b>. Oleh karena itu saya bersedia menerima segala resiko yang akan terjadi. 
                Saya tidak akan menyalahkan atau menuntut pihak dokter hewan xing pet care and clinic 
                apabila sesuatu terjadi pada hewan saya selama proses ${nullable(
                  model.lanjutDengan
                )} berlangsung.
            </p>
        `;
