    ...
    content() {
      ...
      let body = `
          ...
          <p style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';font-size:16px;line-height:1.5em;margin-top:0;text-align:left">
                  ...
                  <p>
                    Menyatakan bahwa saya memahami penjelasan dokter hewan xing pet care and clinic 
                    mengenai kondisi penyakit <b> ${nullable(
                      model.animalType
                    )} ${nullable(model.patientName)} </b>. 
                    Saya bersedia untuk memilih treatment rawat jalan. Saya <b>${
                      model.setujuDatang ? "setuju" : "tidak setuju"
                    } </b>
                    dengan datang setiap hari untuk treatment sesuai dengan perkembangan kondisinya. 
                    Oleh karena itu saya bersedia menerima segala resiko yang akan terjadi. 
                    Saya tidak akan menyalahkan atau menuntut pihak dokter hewan xing pet care and clinic 
                    apabila sesuatu terjadi pada hewan saya selama proses rawat jalan berlangsung.
                </p>
                <p>
                    Saya <b>${
                      model.setujuTest ? "setuju" : "tidak setuju"
                    } </b> untuk dilakukan test lebih lanjut 
                    seperti test ${nullable(model.contohTest)} untuk ${nullable(
        model.animalType
      )} ${nullable(model.patientName)}, dengan alasan <b> ${nullable(
        model.alasan
      )} </b>.
                </p>
                <p>
                    Demikian formulir pernyataan ini dibuat dengan sadar dan sebaik-baiknya, agar tidak ada kesalahpahaman dikemudian hari 
                </p>
        `;
