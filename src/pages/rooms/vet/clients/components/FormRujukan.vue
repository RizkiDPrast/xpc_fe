<template>
  <q-form @submit="onSubmit" class="">
    <div class="row q-col-gutter-sm">
      ...
      <q-input
        class="col-sm-12 col-md-12 q-my-sm q-py-xs"
        v-model="model.diagnosaAwal"
        type="text"
        name="diagnosaAwal"
        label="Diagnosa awal"
        v-validate="'required'"
        :error="errors.has('diagnosaAwal')"
        :error-message="errors.first('diagnosaAwal')"
        :readonly="loading"
        dense
        outlined
        autocomplete="off"
      ...
      <q-input
        class="col-sm-12 col-md-12 q-my-sm q-py-xs"
        v-model="model.tindakan"
        type="textarea"
        rows="3"
        name="tindakan"
        label="Tindakan"
        v-validate="'required'"
        :error="errors.has('tindakan')"
        :error-message="errors.first('tindakan')"
        :readonly="loading"
        dense
        outlined
        autocomplete="off"
      ...
      <q-input
        ...
        type="text"
        name="keDrh"
        label="Ke Dokter hewan"
        v-validate="'required'"
        :error="errors.has('keDrh')"
        :error-message="errors.first('keDrh')"
        :readonly="loading"
        dense
        outlined
        autocomplete="off"
      ...
      <q-input
        class="col-sm-12 col-md-12 q-my-sm q-py-xs"
        v-model="model.permintaanTindakan"
        type="textarea"
        rows="3"
        name="permintaanTindakan"
        label="Permintaan tindakan"
        v-validate="'required'"
        :error="errors.has('permintaanTindakan')"
        :error-message="errors.first('permintaanTindakan')"
        :readonly="loading"
        dense
        outlined
        autocomplete="off"
...
export default {
  ...
  methods: {
    async onSubmit() {
      // if (typeof this.model.clientAgree === "undefined" || this.model.clientAgree === null) {
