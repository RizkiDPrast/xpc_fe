    ...
    content() {
      ...
      let body = `
          ...
          <p style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';font-size:16px;line-height:1.5em;margin-top:0;text-align:left">
               ...
               <p>
               Dengan ini saya memberi kuasa sepenuhnya dan langsung kepada XING pet care and clinic untuk melakukan prosedur yang telah dijelaskan kepada saya.
            </p>
            <p>
                ...
                Saya setuju membayar penuh jasa yang telah diberikan, termasuk yang dianggap perlu untuk pengobatan atau komplikasi bedah atau keadaan yang tidak diperikirakan sebelumnya. Perkiraan pembiayaan yang terlampir hanyalah sekedar perkiraan, dan pembayaran sebenarnya pada akhir perawatan mungkin lebih atau bahkan kurang pada jumlahnya.
            </p>
            <p style=""font-weight:bold;"">
                SEMUA PEMBAYARAN HARUS LUNAS SEBELUM HEWAN PULANG.
            </p>
            <p>
                Semua hewan yang tidak diambil dalam jangka waktu 7 (tujuh) hari setelah pemilik atau yang diberi kuasa oleh pemilik, setelah dikabarkan oleh pihak XING pet care and clinic, maka pihak klinik hewan mempunyai kekuasaan untuk mengatur status kepemilikan baru atau mengurus hewan tersebut selanjutnya.
            </p>
            <p>
                Saya tidak akan menuntut pihak XING pet care and clinic ataupun mengambil kembali hewan saya setelah status kepemilikan hewan tersebut berubah akibat kelalaian yang saya lakukan. 
                Demikian surat pernyataan ini saya buat dengan sebenarnya, dalam keadaan sadar, sehat jasmani dan rohani, serta tanpa paksaan dari pihak manapun juga
            </p>
        `;
