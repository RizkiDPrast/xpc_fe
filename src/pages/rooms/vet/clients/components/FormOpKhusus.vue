  ...
  <q-form @submit="onSubmit" class="">
    <div class="row q-col-gutter-sm">
      ...
      <q-input
        ...
        autocomplete="off"
        debounce="500"
        hint="belum pernah vaksin /satu kali vaksin / dll"
      />
      <q-input
        class="col-sm-12 col-md-12 q-my-sm q-py-xs"
        v-model="model.pertimbangan"
        type="text"
        name="pertimbangan"
        label="Pertimbangan"
        v-validate="'required'"
        :error="errors.has('pertimbangan')"
        :error-message="errors.first('pertimbangan')"
        :readonly="loading"
        dense
        outlined
        autocomplete="off"
      ...
      <q-input
        class="col-sm-12 col-md-12 q-my-sm q-py-xs"
        v-model="model.dirawatDi"
        type="text"
        name="dirawatDi"
        label="dirawat di"
        v-validate="'required'"
        :error="errors.has('dirawatDi')"
        :error-message="errors.first('dirawatDi')"
        :readonly="loading"
        dense
        outlined
        autocomplete="off"
      ...
      <q-input
        class="col-sm-12 col-md-12 q-my-sm q-py-xs"
        v-model="model.vaksinSetelahOp"
        type="text"
        name="vaksinSetelahOp"
        label="Vaksin setelah Operasi"
        v-validate="'required'"
        :error="errors.has('vaksinSetelahOp')"
        :error-message="errors.first('vaksinSetelahOp')"
        :readonly="loading"
        dense
        outlined
        autocomplete="off"
